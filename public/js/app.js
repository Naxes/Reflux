...
tinymce.init({
    ...
    branding: false,
    plugins: 'codesample',
    codesample_languages: [{ text: 'HTML/XML', value: 'markup' }, { text: 'CSS', value: 'css' }, { text: 'JavaScript', value: 'javascript' }, { text: 'PHP', value: 'php' }, { text: 'Java', value: 'java' }, { text: 'Ruby', value: 'ruby' }, { text: 'Python', value: 'python' }, { text: 'C', value: 'c' }, { text: 'C#', value: 'csharp' }, { text: 'C++', value: 'cpp' }],
