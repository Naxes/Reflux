        ...
        <form class="ui form" id="delete_form" action="/posts/{{ $post->id }}" method="post">
            ...
            <div class="ui grid">
                ...
                <div class="six wide column">
                    <button class="ui red fluid button delete_small">Delete</button>    
                </div> 
            </div>                                       
        </form>
    </div>
...
<script>
$('.delete_small_{{ $post->id }}').click(function(){        
    /* Show modal */
...
<script>
    $('.delete_small').prop('disabled', true)    
    $('#post_title_{{ $post->id }}').on('keyup keypress', function(e){
        ...
        if ($(this).val() == '{{ $post->title }}') {
            $('.delete_small').prop('disabled', false)
        } else {
            $('.delete_small').prop('disabled', true)
        }
    });
